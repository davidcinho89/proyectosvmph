...
<div id="main"> 
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Productos</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">  
            ...
            <div style="margin-top: 15px;margin-bottom: 20px">
                <fieldset class="colorleyend" style="width: 100%;">
                    <legend class="colorleyendinto">Productos <?php
...
<?php if ($perfilgrupe == "Superadministrador") { ?>  
                        ...
                        <div style="float: left;height: 16px;  margin-left: 30px;padding-top: 7px;">
...
<?php } ?>  
                            ...
                            <tbody>
                                ...
                                if (sizeof($productos) != 0) {
                                    foreach ($productos as $value) {
                                        ?>
                                        <tr class="class<?php echo $estilo; ?>" id="pro<?php echo $value["id"] ?>"> 
        ...
        ?>
                                            ...
                                            <td class="item2" style="width: 20px;text-align: center">
                                                <?php if ($value['ventas'] == 0) { ?>
                                                    <a id="dell<?php echo sha1($value['id']); ?>" 
                                                       callback="<?php echo $value['nombre']; ?>" 
                                                       tar="index.php?controlador=Products&accion=deletePro" 
                                                       verify="<?php echo strrev(urlencode(base64_encode($value['id']))); ?>" 
                                                       href="#" 
                                                       onclick="confirmfunction3($(this).attr('id'))">
                                                        <img class="delete" src="images/delete.gif" title="Eliminar producto"/>                                                     
                                                    </a>                      
                                                <?php } else { ?>
...
<div style="display: none">
    <div id="contentcall3">
        <div style="text-align: center; margin-bottom: 12px;margin-top: 40px;padding-left: 20px;padding-right: 20px; font-size: 12px">
            Esta seguro de eliminar el producto <strong id="nombrecalldel3"></strong>?
        </div>
        <div style="text-align: center; margin-bottom: 12px;">
...
<script>
    ...
    function confirmfunction3(id) {
        $('#nombrecalldel3').html($('#' + id).attr('callback'));
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.res == 'si') {
                        ...
                        message("Se ha eliminado el producto", "images/iconos_alerta/ok.png");
                        $.fancybox.close();
                    } else {
                        $.fancybox.close();
                        message("No se pudo eliminar el producto", "images/iconos_alerta/error.png");
                        $.fancybox.close();
                    }
                }
            });
