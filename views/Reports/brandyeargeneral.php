            ...
            <div style="margin-top: 0px;margin-bottom: 20px; width: 100%">  
                ...
                foreach ($productos as $key22 => $value8) {
                    ...
                    <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                        <legend class="colorleyendinto">Reporte anual de ventas del producto <?php echo $nombresproductos[$value8] ?></legend>                                                                                               
                                    ...
                                    if (isset($clientes[$value9[2]])) { ?>                                                
                                                ...
                                                <?php for ($index14 = 1; $index14 <=12; $index14++){?> 
                                                 ...
                                                 <td class="item2">
                                                  ...
                                                  <?php }?>      
                                                 <td class="item2"><?php echo number_format($precios2[$key22][$value9[0]][$key22][$value9[0]][$fechaini]["total"]/60,2,",",".") ?>
                                                </td>
...
<?php } }?>  
     ...
     $("#clienteini").change(function(){
             ...
             function redireccion(){
                if(comparai){
                    window.location="index.php?controlador=Reportyear&accion=productyear&productoini="+$('#productoini').val()+"&productofin="+$('#productofin').val()+"&clienteini="+$('#clienteini').val()+"&clientefin="+$('#clientefin').val()+"&tiendafin="+$('#tiendafin').val()+"&tiendaini="+$('#tiendaini').val()+"&fechaini="+$('#fechaini').val()+"&fechafin="+$('#fechafin').val();
                }else{
                    window.location="index.php?controlador=Reportyear&accion=productyear&productoini="+$('#productoini').val()+"&productofin="+$('#productofin').val()+"&clienteini="+$('#clienteini').val()+"&clientefin="+$('#clientefin').val()+"&tiendafin="+$('#tiendafin').val()+"&tiendaini="+$('#tiendaini').val()+"&fechaini="+$('#fechaini').val();
                }
             }
