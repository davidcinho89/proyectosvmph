...
<div class="container" style="margin-bottom: 20px; margin-top: 10px"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte de tiendas comparativo (Marcas)</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>                  
            <div style="width: 100%;">     
                    ...
                    foreach ($clientes as $key22 => $value8) {                         
                        $tablas++;?>                                                                                   
                            <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                                <legend class="colorleyendinto">Reporte de tiendas comparativo de ventas x marca del cliente <?php echo $nombresclientes[$key22] ?></legend>                                                                                               
                                            ...
                                            <thead>  
                                                <tr class="headall">     
                                                    ...
                                                    foreach ($productos as  $key15 => $value10) {                                                                                                 
                                                        $contadorcito++; ?> 
                                                    <th class="head" style="cursor: pointer;" colspan="6"><?php echo $value10?> </th>                                                    
                                                      <?php                                                                                                   
                                                    }
