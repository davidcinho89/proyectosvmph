...
<div class="container" style="margin-bottom: 20px; margin-top: 10px">
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Opciones de búsqueda</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
            ...
            <div style="width: 100%;">     
                ...
                <?php if(!$reportini){?>
                            <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                                <legend class="colorleyendinto">Reporte de ventas de mayor a menor</legend>                                                                                               
                                      <div style="margin-top: 0px;margin-bottom: 20px">   
                                        <table class="mytable" border="0" cellspacing="0" cellpadding="0">      
                                            <thead>  
                                                <tr class="headall">     
                                                    <th class="headinit">Producto</th>
                                                    <th class="head" style="cursor: pointer;">Cajas</th>
                                                    <th class="head" style="cursor: pointer;">Cantidad (UND)</th>
                                                    <th class="head" style="cursor: pointer;">Toneladas</th>
                                                    <th class="head" style="cursor: pointer;">500gr</th>
                                                </tr>                                                                                                      
                                            </thead>     
                                            <tbody style="line-height: 25px">      
                                                <?php                                                  
                                                foreach ($precios as $key777 => $value9) { ?>     
                                                    <tr>                                                        
                                                        <td class="init2"><?php echo $nombresproductos[$key777]  ?> </td>                                                               
                                                         <td class="item2" style="cursor: pointer;">
                                                              <?php echo ceil($value9["cantidad"]/$value9["cajas"]); ?>                                                      
                                                         </td>    
                                                          <td class="item2" style="cursor: pointer;">
                                                              <?php echo $value9["cantidad"]; ?>                                                      
                                                         </td> 
                                                          <td class="item2" style="cursor: pointer;">
                                                              <?php echo $value9["cantidad"]*$value9["gramosxproduto"]/1000000; ?>                                                      
                                                         </td> 
                                                          <td class="item2" style="cursor: pointer;">
                                                              <?php echo $value9["cantidad"]*$value9["gramosxproduto"]/500; ?>                                                      
                                                         </td> 
                                                    </tr>  
    ...
    $(document).ready(function(){ 
       ...
       <?php if(!$reportini){?>
        ...
        $("#clienteini").change(function(){
                    $.ajax({
                        type: "POST",
                        url: "index.php?controlador=ReportUpToDown&accion=gettiendasAjax",
                        dataType: "json",
