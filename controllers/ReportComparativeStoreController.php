...
class ReportComparativeStoreController extends ControllerBase {
    

    public function main(){
       $this->view->setTemplate('Reports' . DS . 'comparativereportStore');
        ...
        if (isset($_GET['anioini'])) {
            ...
            if($periodo=="mes"){                
                $precios = $this->model->traerVentasComparativasMesProducto($productofin2, $tiendafin2, $anioiniselected, $aniofinselected, $mesiniselected, $mesfinselected, $semanainiselected, $semanafinselected);
            }else{
                $precios = $this->model->traerVentasComparativasSemanaProducto($productofin2, $tiendafin2, $anioiniselected, $aniofinselected, $mesiniselected, $mesfinselected, $semanainiselected, $semanafinselected);
            }                        
        } else {
            //Rangos de anios
            $aniomax = date("Y");
