...
<div id="main"> 
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Cargar ventas</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">    
                ...
                <div style="float: left">
                    ...
                    <div>
                        <a style="cursor: pointer; color: #005500; font-weight: bold" 
                           id="subirtttintert"
                           href="index.php?controlador=LoadSales&accion=massiveupload" 
                           title="Carga de archivo de ventas">
                        ...
                        <div style="margin-top: 10px">
                            <a style="cursor: pointer; color: #005500; font-weight: bold" 
                           id="vercargas"
                           href="index.php?controlador=LoadSales&accion=cargasDiferentes" 
                           title="Deshacer carga(s) de ventas">
                            + Deshacer carga(s) de ventas
                        </a>
                        </div>
                        </div>
                </div>
            ...
            <fieldset class="colorleyend" style="width: 98%">
                ...
                <div style="float: left">
                    A continuaci&oacute;n seleccione un rango de fechas de carga de ventas, por defecto se traeran las cargas realizadas en el mes actual.
                    <div id="cajaselect" style="margin-bottom: 15px">    
                        <table>
                            <tr>
                                <td>
                                Cargar ventas desde(A&ntilde;o-Mes): 
                                </td>
                                <td>
            ...
            <?php if ($mensagge&&$mensagge=="Se ha realizado la carga correctamente") { 
                ...
                <div style="width: 265px;">
                    <a href="index.php?controlador=LoadSales&accion=WriteExcelNotify">            
            ...
            <?php } ?>
            <fieldset class="colorleyend" style="width: 98%">
                <legend class="colorleyendinto">Historial de ventas</legend>
                    ...
                    <table class="table" border="0" cellspacing="0" cellpadding="0" id="example">
                        <thead>
                            <tr class="headall">
                                ...
                                <th class="head">Fecha de venta<br>(A&ntilde;o-mes-semana)</th>
                                <th class="head">Precio venta</th>  
                                <th class="head">Cantidad venta</th>                                                                   
...
return (y - x);
    ...
    function redireccion(){
         window.location="index.php?controlador=LoadSales&anioini="+$("#anioini").val()+"&mesini="+$("#mesini").val()+"&aniofin="+$("#aniofin").val()+"&mesfin="+$("#mesfin").val();
    }
</script>
