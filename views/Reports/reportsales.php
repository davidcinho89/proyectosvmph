...
<div class="container" style="margin-bottom: 20px; margin-top: 10px"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte de ventas</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>                  
            <div style="width: 100%;">     
                    ...
                    foreach ($clientes as $key22 => $value8) { 
                        $tablas++;?>                                                                                   
                            <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                                <legend class="colorleyendinto">Reporte de ventas del cliente <?php echo $nombresclientes[$key22] ?></legend>                                                                                               
                                      <div style="margin-top: 0px;margin-bottom: 20px">   
                                        <table class="mytable<?php echo $tablas?>" border="0" cellspacing="0" cellpadding="0">      
                                            <thead>  
                                                <tr class="headall">     
                                                    <th class="headinit" style="cursor: pointer;">Tienda</th>
                                                    <?php  $contadorcito=0; 
                                                    $otro=null;
                                                    foreach ($productos as  $key15 => $value10) {                                                                                                 
                                                        $contadorcito++; ?> 
                                                    <th class="head" style="cursor: pointer;"><?php echo  $nombresproductos[$value10]?> </th>                                                    
                                                      <?php                                                                                                   
                                                }
                                                $columnas[$tablas]=$contadorcito  ?> 
                                                    <th class="head" style="cursor: pointer;">Promedio</th>
                                                </tr>                                                                                                      
                                            </thead>     
                                            <tbody style="line-height: 25px">      
                                                <?php  
                                                $contadortiendasportabla=0;
                                                foreach ($tiendas as $value9) {                                                      
                                                   if($value9[2]==$key22){
                                                       $contadortiendasportabla++;?>     
                                                    <tr>                                                        
                                                    ...
                                                    $contadorxfila=0;
                                                     foreach ($productos as  $key15 => $value10) {
                                                         ...
                                                         <td class="item2" style="cursor: pointer;">
                                                              ...
                                                              $totalporfila=$totalporfila+$precios[1][$key15][$value9[0]];
                                                              if($otro[$key15]['maximo']){
                                                                  $otro[$key15]['maximo'] = $otro[$key15]['maximo']>$precios[1][$key15][$value9[0]]?$otro[$key15]['maximo']:$precios[1][$key15][$value9[0]];
                                                                  $otro[$key15]['minimo'] = $otro[$key15]['minimo']<$precios[1][$key15][$value9[0]]?$otro[$key15]['minimo']:$precios[1][$key15][$value9[0]];                                                    
                                                                  $otro[$key15]['total'] = $otro[$key15]['total']+$precios[1][$key15][$value9[0]];         
                                                              }else{
                                                                  $otro[$key15]['maximo'] = $precios[1][$key15][$value9[0]];
                                                                  $otro[$key15]['minimo'] = $precios[1][$key15][$value9[0]];                                                    
                                                                  $otro[$key15]['total'] = $precios[1][$key15][$value9[0]];   
                                                              }
                                                              ?>                                                      
                                                         </td> 
                                                          <?php }    ?>  
                                                     <td class="item2"><?php echo number_format($totalporfila/$contadorxfila,2,",",".")  ?> </td>    
                                                    </tr>  
                                                    <?php }?>         
                                           <?php } ?>
                                            </tbody> 
                                            <tfoot>                                                
                                                ...
                                                foreach ($productos as  $key15 => $value10) {
                                                    $contadorxfila++;?>                
                                                         <td class="item2" style="cursor: pointer;">
                                                              <?php echo $otro[$key15]['total'];
                                                                      $totalporfila=$totalporfila+$otro[$key15]['total'];?>                                                      
                                                         </td> 
                                                         <?php  }?>  
                                                          <td class="item2"><?php echo number_format($totalporfila/$contadorxfila,2,",",".")  ?> </td>
                                                </tr>
                                                <tr>
                                                    <td class="init2"><strong>PROMEDIO</strong></td>
                                                <?php  foreach ($productos as  $key15 => $value10) {?>                
                                                         <td class="item2" style="cursor: pointer;">
                                                              <?php echo number_format($otro[$key15]['total']/$contadortiendasportabla,2,",",".")?>                                                      
                                                         </td> 
                                                         <?php  }?>  
                                                         <td class="item2" rowspan="3"></td>
                                                </tr>
                                                <tr>
                                                    <td class="init2"><strong>MAXIMO</strong></td>
                                                <?php  foreach ($productos as  $key15 => $value10) {?>                
                                                         <td class="item2" style="cursor: pointer;">
                                                              <?php echo $otro[$key15]['maximo']?>                                                      
                                                         </td> 
                                                         <?php  }?>  
                                                </tr>
                                                <tr>
    ...
    $(document).ready(function(){ 
        ...
        */
        ...
        for ($index = 1; $index <= $tablas; $index++) {?>
           var arraycolum=new Array(<?php echo ($columnas[$index])+2?>)    
           arraycolum[0]=null;               
           <?php for($index2 = 1; $index2 <= $columnas[$index]; $index2++) {?>
