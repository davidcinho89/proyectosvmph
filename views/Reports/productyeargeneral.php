            ...
            <div style="margin-top: 0px;margin-bottom: 20px; width: 100%">  
                ...
                if(!$reportini){                                
                    ...
                    <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                        <legend class="colorleyendinto">Reporte anual de ventas x Producto</legend>                                                                                               
                        <div style="margin-top: 0px;margin-bottom: 20px">   
                            <table class="mytable" border="0" cellspacing="0" cellpadding="0">      
                                ...
                                <?php foreach ($productos as $key22 => $value8) { ?>                                                                                                       
                                                <?php if($fechafin){?>
                                                <tr>
                                                <td class="init2"><?php echo $nombresproductos[$value8] ?> </td> 
                                                <td class="init2"><?php echo $fechaini?> </td> 
                                                <?php for ($index14 = 1; $index14 <=12; $index14++){?> 
                                                 <td class="item2">
                                                    <?php echo $var1=$precios[$key22][$key22][$fechaini][$index14][1]==""?0:$precios[$key22][$key22][$fechaini][$index14][1];
                                                    $total[$index14][1]=$total[$index14][1]+$var1?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var2=$precios[$key22][$key22][$fechaini][$index14][2]==""?0:$precios[$key22][$key22][$fechaini][$index14][2]; 
                                                     $total[$index14][2]=$total[$index14][2]+$var2?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var3=$precios[$key22][$key22][$fechaini][$index14][3]==""?0:$precios[$key22][$key22][$fechaini][$index14][3];
                                                    $total[$index14][3]=$total[$index14][3]+$var3?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var4=$precios[$key22][$key22][$fechaini][$index14][4]==""?0:$precios[$key22][$key22][$fechaini][$index14][4]; 
                                                    $total[$index14][4]=$total[$index14][4]+$var4?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var5=$precios[$key22][$key22][$fechaini][$index14][5]==""?0:$precios[$key22][$key22][$fechaini][$index14][5]; 
                                                    $total[$index14][5]=$total[$index14][5]+$var5?>
                                                 </td>
                                                  <?php }?>     
                                                 <td class="item2"><?php echo number_format($precios[$key22][$key22][$fechaini]["total"]/60,2,",",".") ?>
                                                </td>
                                                <td class="item2"><?php echo $precios[$key22][$key22][$fechaini]["total"] ?>
                                                </td>                                                                                                 
                                                 </tr>
                                                  <tr>
                                                      <td class="init2"><?php $nombresproductos[$value8] ?> </td> 
                                                <td class="init2"><?php echo $fechafin?> </td> 
                                                <?php for ($index14 = 1; $index14 <=12; $index14++){?> 
                                                 <td class="item2">
                                                    <?php echo $var11=$precios2[$key22][$key22][$fechafin][$index14][1]==""?0:$precios2[$key22][$key22][$fechafin][$index14][1];
                                                    $total2[$index14][1]=$total2[$index14][1]+$var11?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var21=$precios2[$key22][$key22][$fechafin][$index14][2]==""?0:$precios2[$key22][$key22][$fechafin][$index14][2]; 
                                                     $total2[$index14][2]=$total2[$index14][2]+$var21?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var31=$precios2[$key22][$key22][$fechafin][$index14][3]==""?0:$precios2[$key22][$key22][$fechafin][$index14][3];
                                                    $total2[$index14][3]=$total2[$index14][3]+$var31?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var41=$precios2[$key22][$key22][$fechafin][$index14][4]==""?0:$precios2[$key22][$key22][$fechafin][$index14][4]; 
                                                    $total2[$index14][4]=$total2[$index14][4]+$var41?>
                                                 </td>
                                                 <td class="item2">
                                                    <?php echo $var51=$precios2[$key22][$key22][$fechafin][$index14][5]==""?0:$precios2[$key22][$key22][$fechafin][$index14][5]; 
                                                    $total2[$index14][5]=$total2[$index14][5]+$var51?>
                                                 </td>
                                                  <?php }?>      
                                                 <td class="item2"><?php echo number_format($precios2[$key22][$key22][$fechaini]["total"]/60,2,",",".") ?>
                                                </td>
                                                <td class="item2"><?php echo $precios2[$key22][$key22][$fechafin]["total"] ?>
                                                </td>
                                                ...
                                                <?php for ($index14 = 1; $index14 <=12; $index14++){?> 
                                                <?php $cambiox=$precios2[$key22][$key22][$fechafin][$index14][1]-$precios[$key22][$key22][$fechaini][$index14][1];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini][$index14][1];?>
                                                 ...
                                                 <?php $cambiox=$precios2[$key22][$key22][$fechafin][$index14][2]-$precios[$key22][$key22][$fechaini][$index14][2];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini][$index14][2];?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td>
                                                 <?php $cambiox=$precios2[$key22][$key22][$fechafin][$index14][3]-$precios[$key22][$key22][$fechaini][$index14][3];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini][$index14][3];?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td>
                                                 <?php $cambiox=$precios2[$key22][$key22][$fechafin][$index14][4]-$precios[$key22][$key22][$fechaini][$index14][4];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini][$index14][4];?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td>
                                                 <?php $cambiox=$precios2[$key22][$key22][$fechafin][$index14][5]-$precios[$key22][$key22][$fechaini][$index14][5];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini][$index14][5];?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td>
                                                  <?php }?>      
                                                 <?php $cambiox=($precios2[$key22][$key22][$fechafin]["total"]/60)-($precios[$key22][$key22][$fechaini]["total"]/60);
                                                        $porcentaje=($cambiox*100)/($precios[$key22][$key22][$fechaini]["total"]/60);?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td> 
                                                 
                                                <?php $cambiox=$precios2[$key22][$key22][$fechafin]["total"]-$precios[$key22][$key22][$fechaini]["total"];
                                                        $porcentaje=($cambiox*100)/$precios[$key22][$key22][$fechaini]["total"];?>
                                                 <td class="item2" style="font-weight: bold;color:<?php if($porcentaje>0){ echo "#007700"; }else{ echo "#770000";}?>">                                                    
                                                        <?php if($porcentaje>0){ echo "+".number_format($porcentaje, 2,",",".")."%"; }else{  echo number_format($porcentaje, 2,",",".")."%";}?>                                                    
                                                 </td>                                                 
                                                </td>
...
<?php } ?>  
     ...
     $("#clienteini").change(function(){
             ...
             function redireccion(){
                if(comparai){
                    window.location="index.php?controlador=Reportyear&accion=productyeargeneral&productoini="+$('#productoini').val()+"&productofin="+$('#productofin').val()+"&clienteini="+$('#clienteini').val()+"&clientefin="+$('#clientefin').val()+"&tiendafin="+$('#tiendafin').val()+"&tiendaini="+$('#tiendaini').val()+"&fechaini="+$('#fechaini').val()+"&fechafin="+$('#fechafin').val();
                }else{
                    window.location="index.php?controlador=Reportyear&accion=productyeargeneral&productoini="+$('#productoini').val()+"&productofin="+$('#productofin').val()+"&clienteini="+$('#clienteini').val()+"&clientefin="+$('#clientefin').val()+"&tiendafin="+$('#tiendafin').val()+"&tiendaini="+$('#tiendaini').val()+"&fechaini="+$('#fechaini').val();
                }
             }
