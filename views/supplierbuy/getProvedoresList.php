...
<div class="container" style="margin-bottom: 20px; margin-top: 20px;min-width: 660px">    
    <fieldset class="colorleyend" style="width: 650px;">
        ...
        <p style="margin-bottom: 20px; margin-top: 0 !important">Seleccione uno de los proveedores de la lista haciendo click en el nombre</p>            
    ...
    $(".selectitem").click(function() {
        $.ajax({
            ...
            success: function(data) {
                parent.actualizarproveedor(data.nombre, data.nit, data.id);
