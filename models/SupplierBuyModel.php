...
class SupplierBuyModel extends ModelBase {
    ...
    public function newSupplier() {
        ...
        $row = $this->db->arrayResult($consult);
        $iduser = $row['nextval'];
        $query = "insert into terceros values ($iduser,'$nombre', $direccion,$telefono,$nit,$ciudad,$celular,'$contacto',$email, $telefono2,'$fechaingreso')";
    ...
    public function crearProducto() {
        ...
        if ($this->db->executeQue("insert into productos " . "
                values($idproducto,$idcategoria,'$nombrepro',$puntos,$idimagen,$iva,'activo',$precio,$precioiva,NULL,NULL,NULL,NULL,NULL,NULL,NULL,100,'$unidad',$referencia)")) {
