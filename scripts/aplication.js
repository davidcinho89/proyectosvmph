        ...
        if (!$(this).attr('disabled')) {
            if ($(this).attr('presence')) {
                ...
                if (res == 'ok') {
                        ...
                        if (res2 == 'ok') {
                            if ($(this).attr('norepeat')) {
                                ...
                                if (res3 == 'ok') {
                                    ...
                                    submitAct = false;
                                    $(this).after('<div style="clear: both"></div><div class="error_input" style="font-size: 12px; color: Red; font-weight: bold;">' + res3 + '</div>');
                                    $(this).css("background-color","#F0CBBA");
                                }
                            }
                        } else {
                            submitAct = false;
                            $(this).after('<div style="clear: both"></div><div class="error_input" style="font-size: 12px; color: Red; font-weight: bold;">' + res2 + '</div>');
                            $(this).css("background-color","#F0CBBA");
                        }
                    } else {
                    }
                    ...
                    submitAct = false;
                    $(this).after('<div style="clear: both"></div><div class="error_input" style="margin-top:8px !important;font-size: 12px; color: Red; font-weight: bold;">' + res + '</div>');
                    $(this).css("background-color","#F0CBBA");
                }
            } else {
                if ($(this).val() != '') {
