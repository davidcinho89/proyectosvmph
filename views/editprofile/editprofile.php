...
<div id="main"> 
    <div class="maxcontent" id="content"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Mi perfil</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>
                        ...
                        <tr>
                            ...
                            <td>                        
                                <?php $view->input("cedula",
                                        ...
                                        array('size' => '20', 'maxlength' => '15','value' => $usuariop->getCedula(), 'readonly' => 'readonly')); ?>
                            </td>
                        </tr>
                        <tr>
