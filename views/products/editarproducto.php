...
if ($perfilgrupe == "Superadministrador") {
    ...
    ?>
                ...
                <tr>
                    ...
                    <td width="30%">
                        $ <?php
                        $view->input("price", "text", "Precio venta", array('required' => true, 'text' => 'decimal', 'minsize' => '1'), array('maxlength' => '8', "size" => "10", 'value' => $producto['precio']));
                        ?> / <?php echo ucfirst($producto['unidad']); ?>.   
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="font-size: 11px">El precio de venta puede ser 0.</td>                   
                </tr>
                <tr>
                    <td>Iva (*): </td>
                    <td width="30%">
                        % <?php
                        $view->input("iva", "numeric", "Iva", 
                                array('required' => true, 'text' => 'digit', 'minsize' => '1'),
                                array('maxlength' => '2', "size" => "4", 'value' => $producto['iva']));
                        ?>    
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="font-size: 11px">El iva puede ser 0.</td>                   
                </tr>
                <tr>
                    <td>Gramos/Unidad de medida(*): </td>
                    <td width="30%">
                        <?php
                        $view->input("gramajerelativo", 
                                "numeric", 
                                "Gramos/Unidad de medida",
                                array('required' => true, 'text' => 'numeric', 'minsize' => '1'),
                                array('maxlength' => '5', 'size' => '6', 'value' => $producto['gramospresentacion']));
                        ?>                            
                    </td>
                </tr>
                <tr>
                    <td>Relaci&oacute;n Producto/Caja(*): </td>
                    <td width="30%">
                        <?php
                        $view->input("relacioncajas", 
                                "numeric", 
                                "Relaci&oacute;n Producto/Caja",
                                array('required' => true, 'text' => 'numeric', 'minsize' => '1'),
                                array('maxlength' => '5', 'size' => '6', 'value' => $producto['relacioncajas']));
                        ?>                            
                    </td>
                </tr>
                <tr>
