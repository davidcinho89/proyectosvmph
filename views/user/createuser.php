        ...
        $('#myform').ajaxForm({
            ...
            success: function(responseText) {
                ...
                if(responseText.respuesta=='si'){                    
                    parent.createData(responseText.id,responseText.nombre,responseText.alias,responseText.perfil, responseText.estado,
                            responseText.grupo,responseText.idcode,responseText.idverify);
