...
<div id="main"> 
    <div class="maxcontent" id="content"> 
        ...
        <div class="container" style="margin-bottom: 20px; margin-top: 10px">
            <p style="margin-top: 20px; font-size: medium">Por favor confirme la informaci&oacute;n del nuevo vinculado antes de terminar el proceso de afiliacion.</p>      
            <p style="font-size: medium; margin-bottom: 0">Informaci&oacute;n del nuevo vinculado:</p>
