...
<div class="container" style="width: 98% !important; margin: 15px auto 0;min-width: 400px;">
    <form id="miform" method="POST" action="index.php?controlador=LoadSales&accion=updateAllStock" enctype="multipart/form-data">
        <fieldset class="colorleyend" style="width: 95%; height: auto">
            <legend class="colorleyendinto">Carga de archivo de ventas</legend>           
            <table style="margin-top: 2px; margin-bottom: 5px">            
                <tr>
                    <td style="padding-left: 10px; vertical-align: middle; padding-bottom: 10px; line-height: 16px; font-size: 13px; text-align: justify" colspan="2">   
                        El formato del archivo debe ser de tipo .xls, .xlsx, csv. Las columnas que debe contener el archivo son: Codigo tienda, Codigo producto, cantidad, precio. 
                    </td>                    
                </tr>
                <tr>
                    <td></td>
        ...
        $('#miform').ajaxForm({
            ...
            success: function(responseText) {               
                if (responseText.respuesta == 'no') {
                    ...
                    $('#archivoex').val('');                    
                    window.parent.location = "index.php?controlador=LoadSales&respuesta=Se ha realizado la carga correctamente&registros="+responseText.registros;
                } else if (responseText.respuesta == 'sierror') {
                    $('#archivoex').val('');                    
                    window.parent.location = "index.php?controlador=LoadSales&respuesta=Se ha realizado la carga correctamente&registros=0";
                }
            }
        });
    });
