...
<div class="container" style="margin-bottom: 20px; margin-top: 10px"> 
        <div id="fancybox-title" class="fancybox-title-float" style="left: 465px; display: block; z-index: 50"><table cellspacing="0" cellpadding="0" id="fancybox-title-float-wrap"><tbody><tr><td id="fancybox-title-float-left"></td><td id="fancybox-title-float-main">Reporte comparativo (Productos)</td><td id="fancybox-title-float-right"></td></tr></tbody></table></div>                  
            <div style="width: 100%;">     
                    ...
                    foreach ($clientes as $key22 => $value8) {                         
                        $tablas++;?>                                                                                   
                            <fieldset class="colorleyend" style="width: 100%; padding: 5px">   
                                <legend class="colorleyendinto">Reporte comparativo de ventas x producto del cliente <?php echo $nombresclientes[$key22] ?></legend>                                                                                               
                                      <div style="margin-top: 0px;margin-bottom: 20px">   
                                        <table class="mytable<?php echo $tablas?>" border="0" cellspacing="0" cellpadding="0">      
                                            <thead>  
                                                <tr class="headall">     
                                                    <th class="headinit" style="cursor: pointer;">Producto</th>                                                                                                   
                                            ...
                                            <tbody style="line-height: 25px">      
                                                ...
                                                foreach ($productos as  $key15 => $value10) {   ?>                                                                                                           
                                                    <tr>                                                        
                                                          <td class="init2"><?php echo $nombresproductos[$value10]  ?> </td>
