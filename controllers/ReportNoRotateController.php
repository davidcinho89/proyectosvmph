...
class ReportNoRotateController extends ControllerBasePrevious {

    public function main() {
        $this->view->setTemplate('Reports' . DS . 'reportnorotate');
        ...
        if (isset($_GET['anioini'])) {
            ...
            $precios=$this->model->traerSinRotacion($productofin2, $tiendafin2, $anioiniselected, $aniofinselected, $mesiniselected, $mesfinselected, $semanainiselected, $semanafinselected);
        } else {
            //Rangos de anios
            $aniomax = date("Y");
            $aniomin = date("Y", strtotime('-1 year'));
