...
class InventoryAdjustController extends ControllerBase {
    ...
    public function WriteExcelResult() {
        ...
        $objPHPExcel->getProperties()->setCreator("Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setLastModifiedBy("Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setSubject("Listado de productos Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setDescription("Listado de productos Plentiful S.A.S.");
    ...
    public function WriteExcelNotify() {
        ...
        $objPHPExcel->getProperties()->setCreator("Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setLastModifiedBy("Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setSubject("Resultado carga masiva Plentiful S.A.S.");
        $objPHPExcel->getProperties()->setDescription("Resultado carga masiva Plentiful S.A.S.");
        $objPHPExcel->setActiveSheetIndex(0);
        $objPHPExcel->getActiveSheet()->SetCellValue('A1', "NOMBRE DEL PRODUCTO");
        $objPHPExcel->getActiveSheet()->SetCellValue('B1', "REFERENCIA");
        $objPHPExcel->getActiveSheet()->SetCellValue('C1', "CANTIDAD FISICA");
