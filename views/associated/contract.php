...
<div class="container" style="margin-bottom: 20px; margin-top: 10px">  
    ...
    <div >
    <textarea rows="20" style="width:860px; text-align: justify" readonly="readonly"><?php $doc->texto('CONTRACT_CONTENT') ?>
    </textarea>
    
        <!--
        <button id="download" class="buscarButton" style="margin-top: 0px;">
            <?php //$doc->texto('DOWNLOAD') ?> PDF
        </button></br></br>
        -->
        </div> 
        <div>
