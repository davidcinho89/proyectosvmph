...
<div align="center">    
    ...
    <fieldset class="colorleyend" style="width: 90%">
        <legend class="colorleyendinto">Editar cliente</legend>
        <table cellspacing="10" border="0" style="width: 100%;line-height: 18px" align="center">
            <tr>
                <td colspan="2" style="font-size: small">
                    A continuaci&oacute;n actualice la informaci&oacute;n del cliente seleccionado, los campos que tienen asterisco "(*)" son obligatorios.
                </td>              
            </tr>
            <tr>
            ...
            <tr>
                <td>Codigo EAN: </td>
                <td width="30%">
                    <?php $view->input("codigotercero", 
                            "numeric",
                            "Codigo EAN", 
                            array('text' => 'numeric', 'norepeat' => 'val5', 'minsize' => '5','except' => $tercero['codigo']), 
                            array('size' => '15', 
                                'maxlength'=> '13', 
...
<?php echo "$deps"; ?>    
            ...
            <tr>
                ...
                <td width="30%">
                    ...
                    $view->input("address_supplier", 
                            ...
                            "Dirección", 
                            array(), 
                            array('size' => '40', 'maxlength' => '80', 'minsize' => '10', 'value' => $tercero['direccion']));
                    ?>            
                </td>
            </tr>
            <tr>
                 ...
                 <tr>
                    ...
                    <td width="30%">
                        ...
                        $view->input("phone_supplier2", 
                                ...
                                "Telefono alterno", 
                                array('text' => 'numeric', 'minsize' => '7'), 
                                array('size' => '12', 'maxlength' => '10', 'value' => $tercero['telefono2']));
                        ?>            
                    </td>
                </tr> 
                <tr>
    ...
    <button class="buscarButton" style="float: left;height: 40px; margin-left: 5%" id="finish">Editar <br>cliente</button>    
            ...
            $('#formSupplier59216').ajaxForm({
                ...
                success: function(responseText) {
                    ...
                    if (responseText.respuesta == 'si') {
                        parent.message("Se han actualizado los datos del cliente", "images/iconos_alerta/ok.png");               
                        parent.updatedata(responseText.id,responseText.nombre,responseText.telefono,responseText.contacto,responseText.email,responseText.codigoean);
                        parent.$.fancybox.close();
                    } else if (responseText.respuesta == 'no') {
                        parent.message('No se ha podido actualizar el cliente', 'images/iconos_alerta/error.png');
                        parent.$.fancybox.close();
