                ...
                if (sizeof($usuarios) != 0) {
                    foreach ($usuarios as $value) {
                        ...
                        <tr class="class<?php echo $estilo; ?>">                                                            
                            ...
                            <td class="item2" style="width: 20px; text-align: center">  
                                <?php if ($value['grupo'] != 'No vinculado') { ?>
...
<script>
    ...
    function createData(id,nombre,alias, perfil, estado, grupo,idcode,idverify){                                 
    ...
    $(document).ready(function(){
        ...
        oTable=$('#mytable').dataTable( {
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                $('td:eq(4)', nRow).css({'text-align':'center','width':'20px'});
                $('td:eq(5)', nRow).css({'text-align':'center','width':'20px'});
                $('td:eq(6)', nRow).css({'text-align':'center','width':'20px'});                
            },
            "aLengthMenu": [
                [10, 20, 50, 100, -1],
                [10, 20, 50, 100, "Todos"]
